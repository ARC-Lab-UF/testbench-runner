...
"""
Given a student_list.txt file, randomly generates demo timeslots for a lab.
...
parser = argparse.ArgumentParser(
    description="automated random list generator for labs."
)
parser.add_argument(
    "-t",
    "--time",
    default="4:05 PM",
    type=str,
    help="lab start time, format: HH:MM AM/PM. Please account for quiz time -- if quiz is 20 min and start is 3:00PM then put 3:20PM as start time",
    required=False,
)
parser.add_argument(
    "-d",
    ...
    default="10",
    type=str,
    help="duration of slot in minutes. Default is 10",
    required=False,
)
parser.add_argument(
    "-f",
    "--file",
    default="studentList.txt",
    type=str,
    help="file of student names, separated by new line",
    required=False,
)
